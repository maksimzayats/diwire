...
def main() -> None:
    ...
    container.register_factory(PrimaryStore, factory=lambda: UserStore(backend="redis"))
    container.register_factory(FallbackStore, factory=lambda: UserStore(backend="memory"))
