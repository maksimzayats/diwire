...
def test_benchmark_dishka_enter_close_scope_no_resolve(benchmark: Any) -> None:
    ...
    def bench_dishka_enter_close_scope_no_resolve() -> None:
        with container(scope=DishkaBenchmarkScope.REQUEST):
            pass
