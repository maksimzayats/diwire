...
# spec: ProviderSpec(slot=1, provides=<class 'int'>, provider=42, provider_kind=<ProviderKind.VALUE: 1>, lifetime=<Lifetime.SINGLETON: 'singleton'>, scope=None, dependencies=[], variables=<__main__._SpecVariables object at 0x379b8588410>)
_dep_1_type: type[Any]
_dep_1_resolver: Any
_dep_1_threading_lock = threading.Lock()
_dep_1_asyncio_lock = asyncio.Lock()

# spec: ProviderSpec(slot=2, provides=<class 'float'>, provider=<function <lambda> at 0x379b9825400>, provider_kind=<ProviderKind.CALL: 2>, lifetime=<Lifetime.SINGLETON: 'singleton'>, scope=None, dependencies=[], variables=<__main__._SpecVariables object at 0x379b8596e10>)
_dep_2_type: type[Any]
_dep_2_resolver: Any
_dep_2_threading_lock = threading.Lock()
_dep_2_asyncio_lock = asyncio.Lock()

# spec: ProviderSpec(slot=3, provides=<class 'str'>, provider=<function <lambda> at 0x379b9825340>, provider_kind=<ProviderKind.CALL: 2>, lifetime=<Lifetime.SINGLETON: 'singleton'>, scope=<Scope.REQUEST: 3>, dependencies=[ProviderDependency(provides=<class 'float'>, parameter=<Parameter "f: float">)], variables=<__main__._SpecVariables object at 0x379b8597950>)
...
class RootResolver:
    ...
    def resolve_1(self) -> Any:
        with _dep_1_threading_lock:
            # registration kind: ProviderKind.VALUE
    ...
    def resolve_2(self) -> Any:
        with _dep_2_threading_lock:
            # registration kind: ProviderKind.CALL
...
class _RequestResolver:
    ...
    def resolve_3(self) -> Any:
        with _dep_3_threading_lock:
            ...
            # resolve dependencies [ProviderDependency(provides=<class 'float'>, parameter=<Parameter "f: float">)]
